...
class CaptioningDataset(Dataset):
    def __init__(self, train: bool):
        super().__init__()
        if train:
            self.x = sorted(glob("data/encodings/train_x_*.pt"))
            self.y = sorted(glob("data/encodings/train_y_*.pt"))
        else:
            self.x = sorted(glob("data/encodings/val_x_*.pt"))
            self.y = sorted(glob("data/encodings/val_y_*.pt"))
